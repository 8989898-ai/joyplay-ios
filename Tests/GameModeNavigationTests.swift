...
guard
    ...
    fullSource.contains("gameWebView.attach(to: view)"),
    !fullSource.contains("view.addSubview(gameWebView)"),
    !fullSource.contains("gameWebView.topAnchor.constraint"),
    !fullSource.contains("gameWebView.bottomAnchor.constraint"),
