...
**Goal:** Make the top back button in half and seven-tenths modes return to the three-Tab screen with the full-screen Tab selected, whether or not an embedded game is visible.
...
1. Add assertions that full screen returns to the previous screen while half and seven-tenths return to the full-screen Tab.
...
2. Install a custom back button whenever half or seven-tenths is selected; remove it for full screen.
